                    ...
                    <div key={miss} className="border border-rasoi-amber/30 bg-rasoi-amber-light rounded-card overflow-hidden">
                      <div className="w-full flex items-center justify-between px-3 py-2.5">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            onClick={() => navigate(`/collect-and-go?ingredient=${encodeURIComponent(miss)}${currentRecipe.cuisine ? `&cuisine=${encodeURIComponent(currentRecipe.cuisine)}` : ''}`)}
                            className="text-xs text-rasoi-dark font-bold"
                          >
                            🛒 Shop it
                          </button>
                        </div>
