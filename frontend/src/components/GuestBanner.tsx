...
export default function GuestBanner() {
  ...
  return (
    <>
      {/* Invisible twin — reserves layout space equal to the fixed banner below,
          so page content (which only pads for the navbar) isn't covered by it. */}
      <div className="invisible px-4 py-2 border-b border-transparent" aria-hidden="true">
        {content}
      </div>
